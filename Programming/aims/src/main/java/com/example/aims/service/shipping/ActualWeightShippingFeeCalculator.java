...
@Component
public class ActualWeightShippingFeeCalculator implements ShippingFeeCalculatorStrategy {
    ...
    public ShippingFeeStrategyType getType() {
        return ShippingFeeStrategyType.ACTUAL_WEIGHT;
    }
    ...
    public ShippingFeeResponse calculate(ShippingFeeCalculationContext context) {
        ...
        BigDecimal shippingFee = calculateShippingFeeByWeight(actualWeight, context.getCity());
